class TicTacToe {
  ...
  getWinner() {
    switch (true) {
      case this.matrix[0][0] == this.matrix[0][1] &&
        this.matrix[0][0] == this.matrix[0][2]:
        return this.matrix[0][0];
      case this.matrix[1][0] == this.matrix[1][1] &&
        this.matrix[1][0] == this.matrix[1][2]:
        return this.matrix[1][0];
      case this.matrix[2][0] == this.matrix[2][1] &&
        this.matrix[2][0] == this.matrix[2][2]:
        return this.matrix[2][0];
      case this.matrix[0][0] == this.matrix[1][0] &&
        this.matrix[0][0] == this.matrix[2][0]:
        return this.matrix[0][0];
      case this.matrix[0][1] == this.matrix[1][1] &&
        this.matrix[0][1] == this.matrix[2][1]:
        return this.matrix[0][1];
      case this.matrix[0][2] == this.matrix[1][2] &&
        this.matrix[0][2] == this.matrix[2][2]:
        return this.matrix[0][2];
      case this.matrix[0][0] == this.matrix[1][1] &&
        this.matrix[0][0] == this.matrix[2][2]:
        return this.matrix[0][0];
      case this.matrix[0][2] == this.matrix[1][1] &&
